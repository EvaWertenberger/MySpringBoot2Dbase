package ru.vertenberger.MySpringBoot2Dbase.controller;
...
import ru.vertenberger.MySpringBoot2Dbase.service.StudentService;
...
public class MyController {
    ...
    public ResponseEntity<String> updateStudent(@RequestBody Student student) {
        ...
        if (updatedStudent != null) {
            return new ResponseEntity<>("Student updated successfully",
                    HttpStatus.OK);
        } else {
            return new ResponseEntity<>("Failed to update student",
